...
\end{align}
```
over the time interval $t\in [0,2\pi]$. Go to the [code](main/matnimation/examples/oscillating_particle/oscillating_particle.py) or [tutorial](examples/oscillating_particle/tutorial_oscillating_particle.md). 
