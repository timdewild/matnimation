...
\end{align*}
```
for $t\in [0,2\pi]$. See the final animation below. We will go through the [code](oscillating_particle/oscillating_particle.py) for this animation step by step. 
