...
\end{align}
```
over the time interval $t\in [0,2\pi]$. Go to the [code](/xamples/oscillating_particle/oscillating_particle.ipynb) or [tutorial](examples/oscillating_particle/tutorial_oscillating_particle.md). 
